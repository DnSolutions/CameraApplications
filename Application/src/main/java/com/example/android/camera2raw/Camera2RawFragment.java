        ...
        public void onCaptureCompleted(CameraCaptureSession session, CaptureRequest request,
            ...
            synchronized (mCameraStateLock) {
                ...
                if (jpegBuilder != null) {
                    ...
                    try {
                        ExifInterface exif = new ExifInterface(jpegBuilder.getSaveLocation());
                        System.out.println("Longitude:"+exif.getAttribute(ExifInterface.TAG_GPS_LONGITUDE_REF) + " " + "Latitude"+(exif.getAttribute(ExifInterface.TAG_GPS_LATITUDE_REF))); //get latitude
                    } catch (IOException e) {
